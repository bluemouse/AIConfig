...
| Git workflow | `commit-message-writer`, `git-guide`, `pull-request-guide`, `code-review-plus` | Draft commit messages → git mechanics (commit/push/rebase/worktrees) → PR authoring → structured diff review |
