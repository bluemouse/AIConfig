...
| Research workflow | `research-guide`, `research-reviewer`, `plan-guide`, `plan-reviewer` | Interactive discovery and research report → readiness audit → implementation plan → plan audit → execution |
