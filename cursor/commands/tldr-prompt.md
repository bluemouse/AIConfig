# Tldr Prompt
Create tldr summaries for Cursor AI files (prompts, agents, instructions, collections), MCP servers, or documentation from URLs and queries.

Use any text after the command as additional context.
...
following the tldr-pages project standards. You MUST transform verbose Cursor AI customization
...
* **Cursor AI customization files** - Files with extensions: .prompt.md, .agent.md,
