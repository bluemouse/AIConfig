...
Validate all installed paths after scaffold or install. Expand bootstrap `wrappers/claude/SKILL.md` or `.claude/skills/<skill-name>/SKILL.md` with Claude eval mechanics and reload notes.
