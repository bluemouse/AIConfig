...
- Bootstrap packages may include a `wrappers/{cursor,claude,github}/SKILL.md` tree used only at install time (`install_portable_skill.py`); it is not copied into `.shared/skills/`.
