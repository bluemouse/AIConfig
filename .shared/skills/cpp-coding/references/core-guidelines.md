# C++20 Core Guidelines

Comprehensive coding standards for modern C++ (C++20) derived from the [C++ Core Guidelines](https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines). Enforces type safety, resource safety, immutability, and clarity.

## Contents

- [When to Use](#when-to-use)
- [Cross-Cutting Principles](#cross-cutting-principles)
- [Philosophy & Interfaces (P.*, I.*)](#philosophy--interfaces-p-i)
- [Functions (F.*)](#functions-f)
- [Classes & Class Hierarchies (C.*)](#classes--class-hierarchies-c)
- [Resource Management (R.*)](#resource-management-r)
- [Expressions & Statements (ES.*)](#expressions--statements-es)
- [Error Handling (E.*)](#error-handling-e)
- [Constants & Immutability (Con.*)](#constants--immutability-con)
- [Concurrency & Parallelism (CP.*)](#concurrency--parallelism-cp)
- [Templates & Generic Programming (T.*)](#templates--generic-programming-t)
- [Standard Library (SL.*)](#standard-library-sl)
- [Enumerations (Enum.*)](#enumerations-enum)
- [Source Files & Naming (SF.*, NL.*)](#source-files--naming-sf-nl)
...
Also complete the build and verification checklist in
[build-and-verification.md](build-and-verification.md#verification-checklist).
