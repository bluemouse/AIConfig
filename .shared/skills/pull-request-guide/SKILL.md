...
How to write a pull request that gets reviewed fast and correctly. This skill owns the
author's craft. Read bundled references on demand — do not load all reference files unless
the task requires them.

## When to Use

- Writing or refining a PR/MR description (what / why / how)
- Sizing, splitting, or stacking changes for reviewability
- Documenting testing evidence and tradeoffs
- Self-reviewing a diff before assigning reviewers
- Setting up or following a lean PR template
