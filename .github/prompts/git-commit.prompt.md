---
name: git-commit
description: Draft a Conventional Commit message for staged changes with commit-message-writer,
  then commit those staged changes without pushing.
agent: agent
argument-hint:
- optional context or "push"
---
