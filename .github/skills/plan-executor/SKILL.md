---
name: plan-executor
description: Use when executing a provided implementation plan in the current git
  working tree — decomposing it into independent units, dispatching concurrent subagents
  through agent-runner when possible, integrating on the current branch without creating
  or switching branches unless explicitly requested, running verifications, and producing
